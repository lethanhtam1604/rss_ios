...
//        let headerText: NSString = "REPORT"
//        
//        // Set the desired font.
//        let font = UIFont(name: "OpenSans-bold", size: 40.0)
//        
//        // Specify some text attributes we want to apply to the header text.
//        let textAttributes = [NSFontAttributeName: font!, NSForegroundColorAttributeName: Global.colorSignin, NSKernAttributeName: 7.5] as [String : Any]
//        
...
//        
//        let font = UIFont(name: "OpenSans-bold", size: 14.0)
...
//        let attributes = [NSFontAttributeName: font!, NSForegroundColorAttributeName: Global.colorSignin]
//        
...
//        context!.setStrokeColor(Global.colorSignin.cgColor)
